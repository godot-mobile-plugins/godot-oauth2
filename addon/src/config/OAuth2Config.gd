...
enum Provider {
	...
	CUSTOM,
	## Provider configuration presets for Google
	GOOGLE,
	## Provider configuration presets for Apple
	APPLE,
	## Provider configuration presets for Discord
	DISCORD,
	## Provider configuration presets for GitHub
	GITHUB,
	## Provider configuration presets for Auth0
	AUTH0
}
...
const PROVIDER_PRESETS = {
	...
	Provider.APPLE:
	{
		...
		# Apple defaults to form_post; requires a backend relay to redirect to app scheme
